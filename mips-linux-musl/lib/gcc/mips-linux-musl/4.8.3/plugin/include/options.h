...
enum opt_code
{
  ...
  OPT_mmt = 1094,                            /* -mmt */
  OPT_mmusl = 1095,                          /* -mmusl */
  OPT_mno_float = 1096,                      /* -mno-float */
  OPT_mno_flush_func = 1097,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1098,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1099,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1100,                     /* -mno-mips3d */
  OPT_mpaired_single = 1101,                 /* -mpaired-single */
  OPT_mplt = 1102,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1103,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1104,               /* -mrelax-pic-calls */
  OPT_mshared = 1105,                        /* -mshared */
  OPT_msingle_float = 1106,                  /* -msingle-float */
  OPT_msmartmips = 1107,                     /* -msmartmips */
  OPT_msoft_float = 1108,                    /* -msoft-float */
  OPT_msplit_addresses = 1109,               /* -msplit-addresses */
  OPT_msym32 = 1110,                         /* -msym32 */
  OPT_msynci = 1111,                         /* -msynci */
  OPT_mtune_ = 1112,                         /* -mtune= */
  OPT_muclibc = 1113,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1114,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1115,                  /* -mvr4130-align */
  OPT_mxgot = 1116,                          /* -mxgot */
  OPT_n = 1117,                              /* -n */
  OPT_no_canonical_prefixes = 1118,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1119,              /* -no-integrated-cpp */
  OPT_noasmopt = 1120,                       /* -noasmopt */
